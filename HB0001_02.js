...
voca02.use().transform('t90, 110').click(playAud01).appendTo(topArea).attr({
    'cursor': 'pointer'
});

var t1 = topArea.text(180, 320, ['lǎoshī', '선생님(老师)']).click(playAud01).attr({
...
function playAud01() {
    var audio1 = new Audio('aud/voca02.mp3');
    audio1.play();
}
...
bottomArea.text(180, 462, '나는 선생님입니다.').attr({
    'font-size': 18,
    'text-anchor': 'middle'
});
...
function handler() {
    ...
    var t3 = bottomArea.text(40, 540, ['Wǒ', 'shì', 'lǎoshī.']).attr({
        'font-family': 'notosans',
        'font-size': 30,
        'fill': 'gray'
    });
    ...
    var audio2 = new Audio('aud/sen02.mp3');
    audio2.play();
}
