...
var hanjas2 = ['女', '鹿', '立', '象', '子', '虎'];
var means2 = ['여자 녀', '사슴 록', '설 립', '코끼리 상', '아들 자', '호랑이 호'];

cardArea.rect(8, 50, 345, 270).attr({
    'fill': '#c3d8d8',
    'opacity': 0.7
});
cardArea.text(43, 130, '가05').attr({
...
function handler01() {
  location.replace('flash_03-01.html');
}
function handler02() {
