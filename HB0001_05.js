...
var voca05 = Paper.image('img/voca05.png', 0, 0, 160, 180).toDefs();
...
function handlerNext() {
    location.replace('HB0001_06.html');
}

// 상단
var topArea = Paper.g();

voca05.use().transform('t100, 100').click(playAud01).appendTo(topArea).attr({
    'cursor': 'pointer'
});

var t1 = topArea.text(180, 320, ['zhíyuán', '회사원(职员)']).click(playAud01).attr({
...
function playAud01() {
    var audio1 = new Audio('aud/voca05.mp3');
    audio1.play();
}
...
function handler() {
    ...
    var t3 = bottomArea.text(43, 540, ['Wǒ', 'shì', 'zhíyuán.']).attr({
        'font-family': 'notosans',
        'font-size': 30,
        'fill': 'gray'
    });
    ...
    var audio2 = new Audio('aud/sen05.mp3');
    audio2.play();
}
